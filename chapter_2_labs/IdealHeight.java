...
public class IdealHeight
{
  public static void main(String[] args)
  {
    ...
    System.out.println("If you are a FEMALE, then your ideal weight range for a height of " + heightFt + "\'" 
                         + heightIn + "\"" + " is " + fmt.format(lowRangeF) + " - " + fmt.format(highRangeF) + "lbs");
    System.out.println("If you are a MALE, then your ideal weight range for a height of " + heightFt + "\'" 
                         + heightIn + "\"" + " is " + fmt.format(lowRangeM) + " - " + fmt.format(highRangeM) + "lbs");
